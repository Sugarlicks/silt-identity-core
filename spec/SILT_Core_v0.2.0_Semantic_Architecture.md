...
Copyright © 2026 Gareth Farry. This specification is licensed under Creative Commons Attribution 4.0 International (CC BY 4.0). That copyright licence does not itself grant patent, trademark or certification rights. The release package contains separate licensing, IPR and conformance notices.
...
24\. Semantic non-inference. For a condition that has entered SILT evaluation, missing semantics produce INDETERMINATE rather than invented law or normative meaning. A condition deliberately left outside evaluation is not converted into an evaluation outcome.
